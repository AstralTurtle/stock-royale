...
function updateStockDaily(stock) {
    ...
    var updatedStock = __assign(__assign({}, stock), { previousClose: newPrices.close, history: __spreadArray(__spreadArray([], stock.history.slice(-29), true), [newPrices], false) });
